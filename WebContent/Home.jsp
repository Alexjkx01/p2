        ...
        <% for (int i = 0; i < categorie.size(); i++) { %>
            <div class="categoria categoria<%= i %>">
                <% switch (i) {
                    case 0: %> 
                        <h2>PLAYSTATION 5</h2>
                        <a href="Ps5.jsp" id="blu">vedi tutta la categoria</a> 
                        <hr>
                        <% break;
                    case 1: %> 
                        <h2>XBOX SERIES</h2>
                        <a href="XboxSeries.jsp" id="blu">vedi tutta la categoria</a> 
                        <hr>
                        <% break;
                    case 2: %> 
                        <h2>NINTENDO SWITCH</h2>
                        <a href="Switch.jsp" id="blu">vedi tutta la categoria</a> 
                        <hr>
                        <% break;
                    case 3: %> 
                        <h2>PLAYSTATION 4</h2>
                        <a href="Ps4.jsp" id="blu">vedi tutta la categoria</a> 
                        <hr>
                        <% break;
                    case 4: %> 
                        <h2>XBOX ONE</h2>
                        <a href="XboxOne.jsp" id="blu">vedi tutta la categoria</a> 
                        <hr>
                        <% break;
                }
