<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="UTF-8" import="it.unisa.model.ProdottoBean, java.util.*, org.apache.commons.lang3.StringEscapeUtils"%>
...
<body>
    ...
    <h2>GESTIONE CATALOGO</h2>
        ...
        <tr>
            <td><%= StringEscapeUtils.escapeHtml4(bean.getNome()) %></td>
            <td><%= StringEscapeUtils.escapeHtml4(bean.getPiattaforma()) %></td>
